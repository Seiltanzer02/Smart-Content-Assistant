...
from backend.services.openrouter_utils import (
    OPENROUTER_API_KEY, openrouter_with_fallback, generate_plan_llm
)
...
from backend.main import supabase, logger  # временно, если отдельного модуля нет
